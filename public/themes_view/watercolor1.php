            ...
            <div class="row justify-content-md-center" style="margin:0 auto;">
                <div class="col-md-12 col-sm-12 col-md-offset-3">
                   ...
                   <p style="margin-top: 20px; text-align: center;">
                    ...
                    " onmouseover="this.style.backgroundColor='#e0cda0'; this.style.color='#4e3b2d';" onmouseout="this.style.backgroundColor='#f5deb3'; this.style.color='#6f4f28';">
                        Buka Undangan
                    </button>
                </div>
                </div>
            ...
            <div class="col-md-12 header-frame" data-aos="fade-down" data-aos-duration="1000">
                <h1><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." <span>&</span> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." <span>&</span> ".$nama_panggilan_pria;?></h1>
                                <p class="mt-3" style="
                                    ...
                                    border: 1px solid #6f4f28; /* Optional: Add border for definition */
                                ">
    ...
    <section class="pt-1 block mx-2">
        ...
        <div class="container">
            <div class="col-md-12 mb-5">
                ...
                <h4 class="mt-0 mb-3">and Happy Wedding</h4>
                
                <h1><?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." <span>&</span> ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." <span>&</span> ".$nama_panggilan_pria;?></h1>
                <br>
                <h2>From Big Family of <a href="https://www.yuknikah.store">yuknikah.store</a></h2>
            </div>
            <div class="row justify-content-md-center">
...
<div style="text-align: center; margin-top: 20px;">
    <button type="button" class="btn-donation" data-toggle="modal" data-target="#modalGift" style="
        background-color: #f5deb3; /* Cream color */
        color: #6f4f28; /* Dark brown color */
        border: none;
        padding: 10px 20px;
        ...
        transition: background-color 0.3s, color 0.3s;
    ">
        <img src="<?php echo base_url() ?>/assets/themes/watercolor1/images/gift-donation.png" alt="donation" style="width:18px; margin-right:5px;">
        Kirim Hadiah
    </button>
</div>
