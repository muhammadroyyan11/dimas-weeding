...
?>
	<div id="over-lay-welcome" style="background-color: white" onclick="openFullscreen()">
		<div class="row" style="margin:0 auto;">
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="sw-invitation-home text-center">
                        ...
                        <img height="200px" width="200px" class="img-responsive" src="<?php echo base_url() ?>/assets/themes/jellyblack/themes-rsvp/sw-vendor/jellyblack/img/sw-wedding-invitation.png" alt="Wedding Invitation Image">
                    
                    
                   
                    <h3>
                        <?php 
                            if ($posisi_mempelai == 0) {
                                echo $nama_panggilan_pria . " & " . $nama_panggilan_wanita;
                            } else {
                                echo $nama_panggilan_wanita . " & " . $nama_panggilan_pria;
                            }
                        ?>
                    </h3>
                    
                    <p>
                        <span id="tanggal-wedding"></span>
                        <input id="tgl_wedding" type="hidden" value="<?= $tgl_acara ?>">
                    </p>
                    
                    <button class="btn btn-primary">Open Invitation</button>
...
<audio id="my_audio" loop src="<?php echo base_url() ?><?= $musiknya ?>"></audio>
	<section>
		<div class="sw-custom-wrapper row" id="sw_fullscreen">
							...
							if($no % 2 == 0){ ?>
								...
								<div class="timeline">
									...
									<div class="timeline-content">
										...
										<h4 class="title text-white" style="color:white"><?php echo $data['judul_cerita']; ?></h4>
										<p class="description text-white" style="color:white">
			...
			<section class="sw-item wow bounceInUp">
                ...
                <div class="sw-content">
                    ...
                    <div class="sw-content-inner">
                        <br><br><br><br><br>
                        <div class="sw-block">
                            <h2>Thankyou<br>And Happy Wedding</h2>
                            <figure>
                                <img src="<?= base_url() ?>/assets/base/img/logo.png" alt="Logo" style="max-width: 150px; height: auto;">
                            </figure>
                            <h2>from the big family of <a href="https://yuknikah.store" class="btn btn-primary" style="background-color: #FF5757">yuknikah.store</a></h2>
                        </div>
                    </div>
                </div>
            </section>
...
$(document).ready(function() {
    // Tunggu 5 detik sebelum mengeksekusi kode berikut
    setTimeout(function() {
        var kode = <?= json_encode($qrcode) ?>;
        var qrUrl = 'https://api.qrserver.com/v1/create-qr-code/?size=230x230&data=' + encodeURIComponent(kode);
